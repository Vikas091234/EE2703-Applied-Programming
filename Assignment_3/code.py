...
Assignment  : 3
Program     : Fitting Data to Models

Description :
Reads noisy data, analyses the effect of noise on
least-squares fitting, estimates model parameters,
and plots the fitted results.
