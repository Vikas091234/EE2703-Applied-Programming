...
Assignment  : 8
Program     : Digital Fourier Transform

Description :
Computes and analyses the discrete Fourier transform
of different continuous-time functions using FFT.
The assignment studies frequency spectra, phase,
sampling effects, modulation, and the Fourier transform
