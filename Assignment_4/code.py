...
Assignment  : 4
Program     : Fourier Approximations

Description :
Computes Fourier-series coefficients for e^x and
cos(cos(x)) using direct integration and least-squares
methods, compares the coefficients, and reconstructs
the functions using the Fourier approximations.
