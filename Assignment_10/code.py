...
Assignment  : 10
Program     : FIR Filters and Discrete-Time Signal Processing

Description :
Analyses a finite impulse response (FIR) filter using
its impulse response and frequency response. The program
performs linear and circular convolution using direct
and FFT-based methods, and analyses the correlation of
