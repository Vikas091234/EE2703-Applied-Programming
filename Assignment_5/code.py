...
Assignment  : 5
Program     : Numerical Solution of Laplace Equation

Description :
Solves the two-dimensional Laplace equation for the
potential distribution in a conducting plate using
the finite-difference method. The program applies
boundary conditions, iteratively computes the potential,
and plots the potential, convergence error, and current
density.
