...
Assignment  : 1
Program     : SPICE Netlist Parser

Description :
Reads a SPICE netlist file, extracts the circuit
definition between the .circuit and .end markers,
parses the circuit elements, and prints the
circuit definition in reverse order.
