...
Assignment  : 7
Program     : Active Filter Analysis using Laplace Transforms

Description :
Analyses low-pass and high-pass active filters using
Laplace transforms and numerical simulation. The program
obtains transfer functions using SymPy, converts them
to LTI systems, and studies their Bode response, step
response, and response to sinusoidal and damped inputs.
