...
Assignment  : 6
Program     : Laplace Transform and LTI Systems

Description :
Uses Laplace-transform based system representations
to analyse continuous-time linear time-invariant
systems. The programs compute impulse responses,
simulate system responses, analyse frequency response,
and study an RLC network.
